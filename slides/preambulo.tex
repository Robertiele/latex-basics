...
\lstdefinestyle{myStyleLatex}{
    ...
    morekeywords = [3]{style,package,document,command,definition, ambiente,book,report,article,exam, beamer,flushright,flushleft,center,figure,table,tabular,tabularx,longtable,article,book,exam,wrapfigure},
    numbers = left,
    numbersep = -1pt,
